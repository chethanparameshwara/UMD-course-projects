...
if __name__ == '__main__':
    ...
    weights_path = '/tmp/turtle_c2_dqn_ep10000.h5' 
    monitor_path = '/tmp/turtle_c2_dqn_ep10000'
    params_json  = '/tmp/turtle_c2_dqn_ep10000.json'
    ...
    last100Filled = False
    # stepCounter = 0 added by chethan
    highest_reward = 0
        ...
        for t in xrange(steps):
            ...
            if stepCounter >= learnStart:
                if stepCounter <= updateTargetNetwork:
                    ...
                    print("i am in minibatch false")
                else :
                    deepQ.learnOnMiniBatch(minibatch_size, True)
                    print("i am in minibatch true")
