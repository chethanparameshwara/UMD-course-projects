...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [x_h cov]=kalman_imu(u, t)
...
for k=2:N
    ...
    [x_h(:,k) quat]=Navigation_equations(x_h(:,k-1),u_h,quat,t(k),t(k-1)); % Subfunction located further down in the file.
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [y,q]=Navigation_equations(x,u,q, t1, t)
